        ...
        <div class="container my-6">
            ...
            <div class="row d-flex flex-column align-items-center position-relative">
                ...
                <ul class="col-8 list-unstyled d-flex justify-content-between position-absolute top-50 start-50 translate-middle">
                    <li class="progressStep bg-primary rounded-circle d-flex justify-content-center align-items-center">
                        <span class="h3 text-white pt-2">1</span>
                    </li>
                    <li class="progressStep bg-danger rounded-circle d-flex justify-content-center align-items-center" v-if="!order.is_paid">
            ...
            <div class="row d-flex mt-6">
                <!--訂單明細-->
                <div class="col-6">
                    <div class=" p-0 border border-third">
                        <div class="order-detail d-flex flex-column ">
                            <h3 class="text-center p-3 mb-2 bg-secondary text-white h4">
                                訂單明細
                            </h3>
                            <table class="mb-0">
                                <thead class="mb-2 border-bottom border-third ">
                ...
                <!--訂單資訊-->
                <div class="col-6">
                    <div class="col-12 p-0 border border-third mb-4 d-flex flex-column justify-content-between">
                        <div class="orderInfor text-white">
                            <h3 class="text-center py-3 bg-secondary h4" v-if="!order.is_paid">確認訂單資料</h3>
                            <h3 class="text-center py-3 bg-secondary h4" v-else>訂購者資訊</h3>
                            <div class="col-12">
                                <div class="d-flex justify-content-center align-items-center flex-column">
                                    ...
                                    <table class="table" v-if="order.user">
                                        <h3 class="text-center py-3 bg-secondary h4">付款狀態</h3>
                                        <div class="text-center py-3">
                                            <span class="text-danger pt-3" v-if="!order.is_paid">目前尚未付款</span>
